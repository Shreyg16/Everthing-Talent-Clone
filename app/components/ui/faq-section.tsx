...
export function FAQSection({ faqs }: FAQSectionProps) {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto ">
      <h2 className="text-4xl font-bold mb-8 text-center text-gray-100">Frequently Asked <span className='bg-gradient-to-r from-[#B11AFF] to-[#FF689F] text-transparent bg-clip-text'>  Questions</span></h2>
      <p className="font-sans font-normal text-[19.38px] leading-[30px] text-center text-slate-400 mb-10">
      Our Commitment at the Core</p>
